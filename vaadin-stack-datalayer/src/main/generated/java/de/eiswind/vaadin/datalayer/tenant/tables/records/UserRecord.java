...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record4<Long, String, String, Boolean> {
	...
	private static final long serialVersionUID = -176087646;
	...
	/**
	 * Setter for <code>tenant.user.password_hash</code>.
	 */
	...
	/**
	 * Getter for <code>tenant.user.password_hash</code>.
	 */
	@NotNull
	@Size(max = 2048)
	...
	/**
	 * Setter for <code>tenant.user.active</code>.
	 */
	...
	/**
	 * Getter for <code>tenant.user.active</code>.
	 */
	@NotNull
