...
public class User extends TableImpl<UserRecord> {
	...
	private static final long serialVersionUID = 797292372;

	/**
	 * The reference instance of <code>master.user</code>
	 */
	...
	/**
	 * The column <code>master.user.password_hash</code>.
	 */
	...
	/**
	 * The column <code>master.user.active</code>.
	 */
	...
	/**
	 * Create a <code>master.user</code> table reference
	 */
	public User() {
		this("user", null);
	}
	...
	/**
	 * Create an aliased <code>master.user</code> table reference
	 */
